...
│   ├── react.development.js    # React 19 dev build (debug builds; generated by scripts/vendor-react.mjs)
│   ├── react-dom.development.js
│   ├── react.production.js     # React 19 minified production build (release builds)
...
Babel's in-browser compile (~1 s at startup). `npm run dev` serves `src/` directly.
