...
- Conversation history is now ordered by when a session was last active (its most recent message or event), not by when it was created — a session resumed days after starting now correctly sorts to the top (#23).
